...
function ControlBar(props) {
  ...
  if (props.isPlaying){
    togglePlayButton =
    <button className='toggle-play-btn' onClick={props.onStopMeasurePlayback}>stop</button>
  } else {
    togglePlayButton =
    <button className='toggle-play-btn' onClick={props.onStartMeasurePlayback}>start</button>
  }
  return (
